...
IMAGENAME=alphazero_gomoku_dockerimage
IMAGETAGCPU=py36_cpu
IMAGETAGGPU=py36_gpu
HOSTPORT=8041
OUTPORT=5000
...
do
	...
	echo "For Example:/home/$USER/OpenSourceProjects/pix2code "
...
then
	...
	then
		sudo docker build -t $IMAGENAME:$IMAGETAGCPU -f ${VOLUMEPATH}/docker/Dockerfile ${VOLUMEPATH}/docker
	else 
